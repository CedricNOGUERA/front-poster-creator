/**
 * Utilitaires avancés pour convertir les PDFs en images
 * Utilise PDF.js via CDN pour éviter les problèmes de dépendances
 */
...
/**
 * Convertit un PDF en images en utilisant PDF.js via CDN
 */
