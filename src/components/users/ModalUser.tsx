...
export const ModalAddUser = ({showAdd, handleCloseAdd, userDataToEdit}: {showAdd: boolean, handleCloseAdd: () => void, userDataToEdit?: UserType | null}) => {
  ...
  return (
    <Modal show={showAdd} onHide={handleCloseAdd}>
      ...
      <Modal.Body>
        <AddUserForm titleButton={titleButton} handleCloseAdd={handleCloseAdd} initialData={userDataToEdit}  />
      </Modal.Body>
    </Modal>
  )
}
