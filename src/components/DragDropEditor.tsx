...
export default function DragDropEditor() {
  ...
  const { setToastData, toggleShow, setFeedBackState } =
    useOutletContext<ContextDragDropEditorType>()
  ...
  // const [selectedCanvas, setSelectedCanvas] = useState<Canvastype>({} as Canvastype)
  ...
  const handleDrop = (e: React.DragEvent<HTMLDivElement>) => {
    ...
    if (!canvasElement) {
      console.error("Canvas ref (posterRef.current) is null in handleDrop. Drop will not be processed.")
      return
    }
  ...
  const updateComponent = (updatedFields: Partial<ComponentTypeMulti>) => {
      ...
      switch (comp.type) {
        ...
        case 'number':
          return {
            ...
            fontFamily: (comp as PrincipalPriceComponentType | NumberComponentType).fontFamily,
        ...
        case 'enableText':
          return {
            ...
            fontFamily: (comp as TextComponentType).fontFamily,
  ...
  }, [ selectedIndex, hoveredIndex, handleDragOnCanvas, getStyleFromComponent])
